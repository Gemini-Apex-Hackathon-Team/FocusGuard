function analyzeFaceAttention(faceResult) {
    if (!faceResult || !faceResult.faceLandmarks || faceResult.faceLandmarks.length === 0) {
        console.log('⚠️ Face Analysis: No face detected');
        return {
            detected: false,
            score: 0,
            details: {}
    ...
    console.log('📊 Face Analysis: Score=' + finalScore.toFixed(2) + 
        ' | Forward=' + headForward + ' | Level=' + headLevel + 
        ' | Eyes Open=' + details.eyesOpen + ' | Eyes Centered=' + details.eyesCentered);
...
function analyzeAttention(faceResult, poseResult) {
    ...
    console.log(
        '🎯 Attention Analysis: Score=' + scoreResult.score + 
